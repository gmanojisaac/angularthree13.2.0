...
@Component({
  selector: 'app-rx-state-inputbinding',
  templateUrl: './rx-state-inputbinding.component.html',
  styleUrls: ['./rx-state-inputbinding.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class RxStateInputbindingComponent{
